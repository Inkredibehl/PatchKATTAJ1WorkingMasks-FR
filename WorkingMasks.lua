...
local MaskEfficiencyTable = {
    ...
    ["Military_FullHelmet_Vanguard-Black"] = 0.75,
    ["Military_FullHelmet_Vanguard-Desert"] = 0.75,
    ["Military_FullHelmet_Vanguard-Green"] = 0.75,
    ["Military_FullHelmet_Vanguard-White"] = 0.75,
